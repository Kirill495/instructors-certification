...
@Import({GradeAssignmentMapperImpl.class, GradeMapperImpl.class, KindOfTourismMapperImpl.class})
class GradeAssignmentMapperTest {
    ...
    void toDTO_date_equalsProtocolDate() {
        ...
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, protocolDate, grade(3), kindOfTourism()));
    ...
    void toDTO_valid_trueWhenValidThroughIsInFuture() {
        ...
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, protocolDate, grade(5), kindOfTourism()));
    ...
    void toDTO_valid_falseWhenValidThroughIsInPast() {
        ...
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, protocolDate, grade(2), kindOfTourism()));
    ...
    void toDTO_valid_falseWhenValidThroughIsToday() {
        ...
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, today.minusYears(3), grade(3), kindOfTourism()));
    ...
    void toDTO_protocolId_isMapped() {
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(42, LocalDate.of(2022, 1, 1), grade(1), kindOfTourism()));
    ...
    void toDTO_grade_isMappedViaGradeMapper() {
        Grade g = grade(2);
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, LocalDate.of(2022, 1, 1), g, kindOfTourism()));
    ...
    void toDTO_kindOfTourism_isMappedViaKindOfTourismMapper() {
        TouristDTO.AssignmentDTO dto =
                mapper.toDTO(projection(1, LocalDate.of(2022, 1, 1), grade(1), kindOfTourism()));
