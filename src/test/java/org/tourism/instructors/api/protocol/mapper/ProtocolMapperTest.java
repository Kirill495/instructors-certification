...
class ProtocolMapperTest {
    ...
    @MockitoBean ProtocolContentMapper protocolContentMapper;
    ...
    private ProtocolRepository.ProtocolProjection projection(
            Integer id, String number, LocalDate date) {
    ...
    class ToFormDTO {
        ...
        void contentRows_delegatedToProtocolContentMapper() {
            ProtocolContent content = new ProtocolContent();
            ProtocolContentFormRow stub =
                    new ProtocolContentFormRow(1, 1, 1, "Tourist", 1, 1, null, null);
    ...
    class ToEntity {
        ...
        void protocolContents_delegatedToProtocolContentMapper() {
            ...
            ProtocolFormDTO dto =
                    new ProtocolFormDTO(
                            1, "П-001", LocalDate.now(), "o", ProtocolStatus.DRAFT, List.of(row));
            Protocol entity = mapper.toEntity(dto);
        ...
        void nullContentRows_protocolContentsIsNull() {
            ProtocolFormDTO dto =
                    new ProtocolFormDTO(
                            1, "П-001", LocalDate.now(), "o", ProtocolStatus.DRAFT, null);
